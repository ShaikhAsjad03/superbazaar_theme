      ...
      <div className="flex flex-col lg:flex-row gap-6">
                  ...
                  >
                          ...
                          <div className="mt-3">
                            ...
                            {openCatalogueIds.includes(item.id) && (
                              <div className="mt-2 space-y-2 pl-4 border-l">
                                {item.products.map((p) => (
                                  <div key={p.code} className="flex items-center justify-between text-sm gap-2">
                    ...
                    <div className="col-span-2 mt-2 md:mt-0">
                      <div className="flex items-center border border-gray-400 rounded-md overflow-hidden w-24 md:w-20">
                        ...
                        <span className="p-1 flex-1 text-center text-md">{item.quantity}</span>
                        <button
                    ...
                    <div className="col-span-2 flex justify-between md:justify-end items-center gap-2 font-medium mt-2 md:mt-0">
                      ...
                      >
                        {deleteLoading === item.id ? <Loader2 className="animate-spin" size={20} /> : <Trash2 size={20} />}
                      </button>
                    </div>
                  </div>
                );
        ...
        <div className="w-full lg:w-1/3 bg-white shadow rounded-2xl p-6">
          ...
          <button
            ...
            className="mt-6 mb-10 block w-full bg-indigo-600 hover:bg-indigo-700 text-white p-3 rounded-lg font-medium shadow-lg transition-transform transform hover:scale-105 text-center"
          >
            Proceed to Checkout
          </button>
          ...
          <div className="mt-6 flex flex-col items-center">
            ...
            />
            <p className="mt-2 text-sm text-zinc-900 text-center">
