...
const Popups = () => {
  ...
  return (
    <>
      {visiblePopups && visiblePopups?.map((popup) => (
        <div key={popup.id} className="fixed inset-0 z-50">
          ...
          >
            <div
              className={`bg-white shadow-lg  relative animate-fadeIn flex flex-col
    ${popup.type === "newsletter"
            ...
            >
              <button
                className="absolute top-2 right-2 text-zinc-900 hover:text-black z-10"
              ...
              {popup.image && (
                <div
                  className={`w-full ${popup.type === "newsletter"
                      ? "h-75 "
              ...
              <div
                className={`w-full ${popup.type === "newsletter" ? "" : "md:w-1/2"
                  } p-6 flex flex-col justify-center text-center md:text-left`}
              >
                <h2
                  className={`text-xl font-bold mb-3 ${popup.headingStyle === "center"
                      ? "text-center"
